...
// Blog posts data — moved to /data/blog-posts.json on 2026-07-23. Loaded
// synchronously so `blogPosts` is populated immediately, exactly as before;
// functions below still read/mutate this same array in place (push/splice
// for admin edits), unaffected by where its initial content came from.
const blogPosts = loadJSONSync('data/blog-posts.json') || [];
// ============================================================================
