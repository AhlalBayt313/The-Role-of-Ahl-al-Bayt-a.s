            ...
            <div class="flex items-center justify-between gap-2">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <button data-action="changePage" data-param="home"
                        ...
                        <div style="padding:4px 10px;border-radius:12px;background:${d?'rgba(253,246,227,.95)':'transparent'};display:flex;align-items:center;flex-shrink:0;transition:transform var(--t-spring)" class="group-hover:scale-105">
                            <img src="assets/images/logo-mark.png" alt="${l==='bn'?'আহলে বাইত':'Ahl al-Bayt'}" style="height:38px;width:auto;display:block" />
                        </div>
            ...
            <div class="grid md:grid-cols-3 gap-10">
                ...
                <div>
                    <div class="flex items-center gap-3 mb-5">
                        <div style="padding:5px 12px;border-radius:14px;background:rgba(253,246,227,.95);display:flex;align-items:center;flex-shrink:0;box-shadow:0 4px 18px rgba(0,0,0,.25)">
                            <img src="assets/images/logo-mark.png" alt="${l==='bn'?'আহলে বাইত (আ.)':'Ahl al-Bayt (a.s)'}" style="height:46px;width:auto;display:block" />
                        </div>
                        <div>
